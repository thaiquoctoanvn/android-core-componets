package com.whistle.corecomponents.ui.category.cameranvision
...
import com.whistle.corecomponents.databinding.CameraUiContainerBinding
import com.whistle.corecomponents.databinding.FragmentCameraBinding
...
class CameraFragment : BaseFragment<FragmentCameraBinding>(FragmentCameraBinding::inflate) {
    ...
    private val permissionsRequired = arrayOf(Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE)
    ...
    private fun bindCameraUseCase() {
        ...
        imageAnalysis = ImageAnalysis.Builder()
            ...
            .build()
            .also { ia ->
                // Custom ur Analyzer if need
                ia.setAnalyzer(cameraExecutor) {
                    it.imageInfo
                }
            }
    ...
    private fun setGalleryThumbnail(uri: Uri) {
        cameraUiContainerBinding?.photoViewButton?.apply {
            post {
                setPadding(resources.getDimension(R.dimen.padding_4dp).toInt())
                Glide.with(this)
                    .load(uri)
